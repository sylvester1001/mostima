...
我使用了blowfish, 所以接下来的内容都已blowfish为例.
...
定义整个网站的header风格, 可以选择的参数有 `basic`, `fixed`, `fixed-fill`, `fixed-fill-blur`
...
8. 再将以下几行的内容替换
   ...
   即将复制代码中的`PAGE_ID`, `PAGE_URL`, `PAGE_TITLE` 分别替换为`.File.UniqueID`, `.Permalink`, `.Title`
